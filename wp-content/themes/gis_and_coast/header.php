				...
				<div class="row">
					<div class="col-sm-12 col-md-12">
						...
						<div class="fright">
							...
							<span class="fleft size_12 uds-caption"><?echo __('Grupo de investigación RNM-177','gis')?><br><?echo __('Universidad de Sevilla','gis')?><br><?echo __('PAIDI. Junta de Andalucía','gis')?></span>
